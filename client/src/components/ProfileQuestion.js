...
export default class ProfileQuestion extends React.Component {
    constructor(props) {
        super(props)
    ...
    render() {
        ...
        return (
            <tr className="question-row" key={this.props.question.qid}>
                ...
                <td className="row2">
                    <p id={this.props.question.qid} onClick={() => this.props.renderProfilePage("editQuestion", this.props.question.qid, undefined, undefined)} className="question-title">{this.props.question.title}</p>
